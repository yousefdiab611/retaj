...
adminProductsRouter.post(
  ...
  (req, res) => void adminProductController.create(req, res),
);
adminProductsRouter.patch(
  "/:id",
  sensitiveWriteRateLimiter,
  (req, res) => void adminProductController.update(req, res),
);
adminProductsRouter.delete(
  "/:id",
  sensitiveWriteRateLimiter,
  (req, res) => void adminProductController.remove(req, res),
);
